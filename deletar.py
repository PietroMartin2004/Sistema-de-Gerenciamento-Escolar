...
def excluir_aluno():
    ...
    matricula = input(
        "Informe a matricula do aluno que deseja excluir do sistema: ")

    # Solicitar confirmação
    confirmacao = input(f'Você tem certeza que deseja excluir o aluno com matricula {
                        matricula}? (s/n): ')
    ...
    if confirmacao == 's' or confirmacao == 'sim':
        try:
            ...
            if aluno:
                ...
                logging.warning(f'Aluno com matricula {
